...
const SidebarMenuButton = React.forwardRef((
  ...
  const menuButtonContent = (
    <Comp
      ...
      className={cn(
        ...
        isActive && !className && "bg-sidebar-accent font-medium text-sidebar-accent-foreground",
        className
      )}
      {...props} />
  )
  ...
  if (isCollapsed && React.Children.count(props.children) > 1) {
    ...
    const textContent = childArray.length > 1 && React.isValidElement(childArray[1]) 
