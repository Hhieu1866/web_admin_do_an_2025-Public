                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <Input
                                    ...
                                    className={`pl-10 focus:ring-primary ${errors.oldPassword ? 'border-red-500 focus:ring-red-500' : ''}`}
                                />
                            </div>
                            {errors.oldPassword && (
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <Input
                                    ...
                                    className={`pl-10 focus:ring-primary ${errors.newPassword ? 'border-red-500 focus:ring-red-500' : ''}`}
                                />
                            </div>
                            {errors.newPassword && (
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <Input
                                    ...
                                    className={`pl-10 focus:ring-primary ${errors.confirmPassword ? 'border-red-500 focus:ring-red-500' : ''}`}
                                />
                            </div>
